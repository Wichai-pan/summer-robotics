    ...
    try:
        ...
        try:
            while True:
                ...
                # Handle VR input for both arms（左右手柄已对调，修正控制反向）
                left_arm.handle_vr_input(right_goal, gripper_state=None)
                right_arm.handle_vr_input(left_goal, gripper_state=None)
