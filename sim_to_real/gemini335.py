...
class Gemini335Camera:
    ...
    def start(self) -> CameraIntrinsics:
        ...
        # Auto exposure and auto white balance need multiple delivered frames to
        # settle after stream startup. These frames are deliberately discarded,
        # so they can never enter perception sampling or its diagnostic sheet.
        print(
