...
- [客厅房间建模结果（2026-09-02）](20-living-room-model-20260902T194820Z.md):
  最近一次通过复核的 RGB-D 房间地图、可视化结果、质量指标和可复用二维地图文件；
- [家庭导航首个稳定往返基线（2026-09-06）](21-home-navigation-roundtrip-baseline-20260906.md):
  新地图四个定位点、桌面与沙发双向五段路线、最终误差和主动停车验收结果；
